...
<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse">  
    <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
            ...
            <!--            </li>-->
            <!--            <li class="nav-item ms-4">-->
            <!--                <a class="font-num nav-link" href="toShip.php"><i class="fa-solid fa-circle-dot"></i>&nbsp To Ship</a>-->
            <!--            </li>-->
            <!--            <li class="nav-item ms-4">-->
            <!--                <a class="font-num nav-link" href="toReceived.php"><i class="fa-solid fa-circle-dot"></i>&nbsp To Received</a>-->
            <!--            </li>-->
            <!--            <li class="nav-item ms-4">-->
            <!--                <a class="font-num nav-link" href="completeDeliver.php"><i class="fa-solid fa-circle-dot"></i>&nbsp Complete</a>-->
            <!--            </li>-->
            <!--        </ul>-->
            <!--    </div>-->
            <!--</li>-->
            ...
            <!--            </li>-->
            <!--            <li class="nav-item ms-4">-->
            <!--                <a class="font-num nav-link" href="ptoShip.php"><i class="fa-solid fa-circle-dot"></i>&nbsp To Ship</a>-->
            <!--            </li>-->
            <!--            <li class="nav-item ms-4">-->
            <!--                <a class="font-num nav-link" href="ptoReceived.php"><i class="fa-solid fa-circle-dot"></i>&nbsp To Received</a>-->
            <!--            </li>-->
            <!--            <li class="nav-item ms-4">-->
            <!--                <a class="font-num nav-link" href="pcompleteDeliver.php"><i class="fa-solid fa-circle-dot"></i>&nbsp Complete</a>-->
            <!--            </li>-->
            <!--        </ul>-->
            <!--    </div>-->
            <!--</li>-->
            ...
            <li class="nav-item mt-2">
                <a class="font-num nav-link text-start ms-2" data-bs-toggle="collapse" href="#staffCollapse" aria-expanded="false" aria-controls="staffCollapse">
                ...
                <div class="collapse" id="staffCollapse">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item ms-4">
                            <a class="font-num nav-link" href="StaffList.php"><i class="fa-solid fa-circle-dot"></i>&nbsp List of Staff</a>
                        </li>
                        <li class="nav-item ms-4">
                            <a class="font-num nav-link" href="AddStaff.php"><i class="fa-solid fa-circle-dot"></i>&nbsp Add Staff</a>
                        </li>
                    </ul>
                </div>
            </li>
