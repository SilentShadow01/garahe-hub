<?php
    ...
    if (isset($_POST['completeBtn'])) {
        ...
        $updateQuery = "UPDATE users_reservation_tbl SET reservationStatus = 'complete' WHERE transactionNumber = '$transactionNumber'";
...
<body style="background-color: #C08261;">
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="background-color: #F2E8C6;">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom border-dark">
                    <h1 class="h2" id="currentPage"><i class="fa-regular fa-calendar"></i>&nbsp Events</h1>
                </div>
                    ...
                    <table class="border border-secondary" id="tableDineIn">
                        <thead class="text-light" style="background-color: #800000 !important ;">
                            <tr>
                                ...
                                <th class="font_me border border-secondary">Time Countdown</th>
                            </tr>
                        </thead>
                        <tbody class="border border-secondary">
                            <?php

                                $query = "SELECT * FROM users_reservation_tbl WHERE reservationStatus = 'approved'";
                                                            ...
                                                            <div class="container">
                                                                ...
                                                                <div class="input-group mt-1">
                                                                    ...
                                                                    <div class="input-group mt-1">
                                                                        ...
                                                                        <input type="text" class="form-control text-center" value="<?= $row['reservationFullName']; ?>" readonly> 
                                                                    </div>
                                                                    <div class="input-group mt-1">
                                                                        <strong class="input-group-text col-4">Event type</strong>   
                                                                        <input type="text" class="form-control text-center" value="<?= $row['eventType']; ?>" readonly> 
                                                                    </div>
                                                                    <div class="input-group mt-1">
                                                        ...
                                                        <form method="POST">
                                                            <div class="modal-body bg-body-tertiary">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="submit" class="btn btn-success" name="completeBtn">Complete</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
    ...
    $(document).ready(function() {
        function updateCountdown() {
            ...
            $('#tableDineIn tbody tr').each(function(index, row) {
                var countdownCell = $(row).find('.countdown'); // Assuming you have a cell with class 'countdown'

                // Get the countdown time from the cell's data attribute
                var countdownTime = parseInt(countdownCell.data('countdown'));

                // Update the countdown display
                var minutes = Math.floor(countdownTime / 60);
                var seconds = countdownTime % 60;
                countdownCell.text(minutes + ':' + (seconds < 10 ? '0' : '') + seconds);

                // Update the countdown time for the next second
                countdownTime -= 1;
                countdownCell.data('countdown', countdownTime);

                // Check if the countdown is done
                if (countdownTime <= 0) {
                    // You can add additional logic for when the countdown reaches zero
                }
            });
        }
