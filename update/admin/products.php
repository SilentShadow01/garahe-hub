                                                        ...
                                                        <div class="modal-body" style="background-color: #F2E8C6;">
                                                            <div class="container">
                                                                ...
                                                                <form method="POST">
                                                                    ...
                                                                    <div class="input-group mt-1">
                                                                        <strong class="text-light input-group-text border-dark col-4" style="background-color: #C08261;">Product Quantity</strong>    
                                                                        <input type="number" class="form-control text-center border-success" id="productQuantity" name="productQuantity" value="<?= $row['productStocks']; ?>">
                                                                    </div>
                                                                    <div class="input-group mt-1">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            ...
                            <div class="modal-body" style="background-color: #F2E8C6;">
                                <form class="row g-3" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6 mt-3">
                                        <strong for="productName" class="form-label">Product Quantity<span class="text-danger"> * </span></strong>
                                        <input type="text" class="form-control border-success" id="productQuantity" name="productQuantity" required>
                                    </div>
                                    <div class="col-md-6">
