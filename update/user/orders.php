    ...
    <div class="main-content">
        <div class="container">
            <ul class="nav nav-tabs mt-2 border-dark" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link text-dark" id="to-ship-tab" data-bs-toggle="tab" href="#to-ship" role="tab" aria-controls="to-ship" aria-selected="true">Approved</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link text-dark" id="to-received-tab" data-bs-toggle="tab" href="#to-received" role="tab" aria-controls="to-received" aria-selected="false">To be delivered</a>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link text-dark" id="complete-tab" data-bs-toggle="tab" href="#cancelled" role="tab" aria-controls="cancelled" aria-selected="false">Cancelled</a>
                </li>
            </ul>
            <div class="tab-content mt-2 rounded p-2 border-dark" id="myTabContent">
                ...
                <div class="tab-pane fade" id="to-received" role="tabpanel" aria-labelledby="to-received-tab">
                                ...
                                <table id="toDeliverTable">
                                    ...
                                    <tbody class="border border-secondary">
                                        <?php
                                            $usersEmail2 = $_SESSION['users_email'];
                                            $query2 = "SELECT *
                                            FROM user_delivery_tbl WHERE orderStatus = 'to-received' AND userEmailAddress = '$usersEmail2' 
                                            GROUP BY userEmailAddress, orderDate, orderTime";
                                            $result2 = mysqli_query($conn, $query2);
                ...
                <table id="cancelledTable">
                    ...
                    <tbody class="border border-secondary">
                        ...
                        if (mysqli_num_rows($result2) > 0) {
                                                        ...
                                                        <form method="POST" action="updateDeliver.php">
                                                            ...
                                                            <div class="form-control mt-1">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <label class="pt-4 form-check-label d-flex justify-content-center font-num fw-semibold" for="productCheckbox<?= $additionalRow['productID']; ?>">
                                                                            <span class="font-num">Total Price: </span><?= $additionalTotal ; ?>
                                                                        </label>
                                                                    </div>
                                                                </div>
                            ...
                            echo '<tr><td colspan="5" class="text-center">No cancelled orders found.</td></tr>';
                        }
                        ?>
                    </tbody>
                </table>
