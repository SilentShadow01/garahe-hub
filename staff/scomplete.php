        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="background-color: #F2E8C6;">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom border-dark">
                    <h1 class="h2" id="currentPage"><i class="fa-solid fa-truck"></i>&nbsp Deliver > Complete</h1>
                </div>
                                                            ...
                                                            <div class="container">
                                                                ...
                                                                <form method="POST" action="updateDeliver.php">
                                                                    ...
                                                                    <?php 
                                                                        ...
                                                                        $additionalSql = "SELECT * FROM user_delivery_tbl WHERE orderDate = '$rowDate' AND orderTime= '$rowTime' AND orderStatus = 'complete' AND modeOfClaim = 'delivery'";
