        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="background-color: #F2E8C6;">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom border-dark">
                    <h1 class="h2" id="currentPage"><i class="fa-solid fa-truck"></i>&nbsp Complete Delivery</h1>
                </div>
                    ...
                    <table class="border border-secondary" id="tableDineIn">
                        ...
                        <tbody class="border border-secondary">
                            <?php
                                ...
                                $sql = "SELECT *
                                FROM user_delivery_tbl WHERE orderStatus = 'complete' AND modeOfClaim = 'delivery'
                                ...
                                if (mysqli_num_rows($result) > 0)
                                {
                                    ...
                                    { 
                                        ...
                                        ?>
                                        <tr>
                                            <td class="font-num border border-secondary font-num"><?= $row['transactionNumber'] ?></td>
                                            <td class="font-num border border-secondary font-num"><?= date('F d, Y', strtotime($row['orderDate'])); ?></td>
                                            <td class="font-num border border-secondary font-num"><?= $row['orderTime'] ?></td>
                                            <td class="font-num border border-secondary font-num"><?= $row['receiverPhoneNumber'] ?></td>
                                            ...
                                            <td class="font-num border border-secondary d-flex justify-content-center font-num">
                                                            ...
                                                            <div class="container">
                                                                ...
                                                                <form method="POST" action="updateDeliver.php">
                                                                    ...
                                                                    <div class="input-group mt-1">
                                                                        ...
                                                                        <input type="text" class="font-num form-control text-center"  value="<?php if($row['orderStatus'] === 'complete') echo "Complete"; ?>" readonly>
                                                                    </div>
