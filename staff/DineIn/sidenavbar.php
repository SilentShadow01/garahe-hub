        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item mt-2">
                ...
                <div class="collapse" id="dineInCollapse">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item ms-4">
                            <a class="font-num nav-link" href="dineIn.php"><i class="fa-solid fa-circle-dot"></i>&nbsp Rejected</a>
                        </li>
                        <li class="nav-item ms-4">
                            <a class="font-num nav-link" href="pending.php"><i class="fa-solid fa-circle-dot"></i>&nbsp Pending</a>
                        </li>
                        <li class="nav-item ms-4">
                            <a class="font-num nav-link" href="approve.php"><i class="fa-solid fa-circle-dot"></i>&nbsp Approved</a>
                        </li>
                        <li class="nav-item ms-4">
                            <a class="font-num nav-link" href="complete.php"><i class="fa-solid fa-circle-dot"></i>&nbsp Complete</a>
                        </li>
